...
%----------------------------------------------------------------------------------------
  ...
  \textsc{\Large WINDOWS PROGRAMMING (ANDROID)}\\[0.5cm] % Major heading such as course name
...
\newcommand{\HRule}{\rule{\linewidth}{0.5mm}} % Defines a new command for the horizontal lines, change thickness here
  ...
  \vspace{10 mm}
  \HRule \\[0.4cm]
  { \LARGE \bfseries Advanced Form Elements. Child Windowses. Basics of Working With Keyboard. }\\[0.4cm] % Title of your document
  \HRule \\[1.5cm]
